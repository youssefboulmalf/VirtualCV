        ...
        return (
            <div className={css.header}>
                <div className={css.headerText}>
                    <h1 className={css.headTitle}>Welcome to my Virtual Curriculum Vitae</h1>
                    <p className={css.headText}>The perpose of this Virtual Curriculum Vitae is to introduce myself and to demonstrate my develop skills.</p>
                </div>
