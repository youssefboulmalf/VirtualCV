    ...
    return (
        <div className={css.crossWord}>
            <div className={css.letterGrid}>
                ...
                <div className={css.letter}>S</div>
                ...
                <div className={css.letter}>M</div>
                ...
                <div className={css.letter}>I</div>
                <div className={css.letter}>Z</div>
                <div className={css.letter}>K</div>
                <div className={css.letter}>O</div>
                <div className={css.letter}>Q</div>
                <div className={css.letter}>C</div>
                <div className={css.letter}>W</div>
            ...
            <div className={css.outline1}></div>
            <div className={css.outline2}></div>
            <div className={css.outline3}></div>
